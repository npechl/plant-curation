...
## Requirements
These steps assume you’re using **Linux or macOS**. Windows isn’t officially supported, but you can run everything on [WSL](https://learn.microsoft.com/en-us/windows/wsl/install). 
